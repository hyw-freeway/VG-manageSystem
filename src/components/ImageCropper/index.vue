          ...
          <div v-show="true" class="vicp-crop-right">
            <div class="vicp-preview">
              <div v-if="!noSquare" class="vicp-preview-item">
                <img :src="data" :style="previewStyle">
...
export default {
  ...
  methods: {
    ...
    createImg(e) {
      ...
      this.data = canvas.toDataURL(mime)
    },
    prepareUpload() {
      const { url, data, field, ki } = this
      this.$emit('crop-success', data, field, ki)
